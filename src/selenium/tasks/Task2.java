...
//         TODO:
        driver.findElement(By.id("fb_name")).sendKeys("David");
        ...
        driver.findElement(By.cssSelector("textarea.w3-input")).sendKeys("Hello");

        Thread.sleep(5000);
        driver.findElement(By.className("w3-btn-block")).click();

//         check fields are filled correctly
        assertEquals("David", driver.findElement(By.id("name")).getText());
...
//         check message text: "Thank you, NAME, for your feedback!"
        assertEquals("Thank you, David, for your feedback!", driver.findElement(By.id("message")).getText());
