...
//         get first text of class "test" (should be "Test Text 1")
        System.out.println(driver.findElement(By.className("test")).getText()); //return the 1st one
        System.out.println(driver.findElements(By.className("test")).get(0).getText()); // specify the element index
    }
