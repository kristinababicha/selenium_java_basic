...
//        enter a number under "Number"
        String enteredNumber = "555";
        driver.findElement(By.name("vfb-9")).clear();
        driver.findElement(By.name("vfb-9")).sendKeys(enteredNumber);
...
//        check that the correct Text appears ("You entered number: "NUMBER YOU ENTERED"")
        assertEquals("You entered number: \"" +enteredNumber + "\"", driver.findElement(By.id("result_number")).getText());
