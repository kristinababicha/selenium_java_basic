...
//         * but loading text is seen instead   "Loading green..."
        Assert.assertTrue(driver.findElement(By.id("loading_green")).isDisplayed());
...
//         * success is seen instead "Green Loaded"
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.id("finish_green"))); //check for existing in the HTML
...
//         0) wait until button to load green and blue appears
          wait.until(ExpectedConditions.elementToBeClickable(By.id("start_green_and_blue"))); // check for clickable element
