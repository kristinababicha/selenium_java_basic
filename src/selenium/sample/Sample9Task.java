...
public class Sample9Task {
    ...
    public void openPage() {
        ...
        System.out.println(driver.findElement(By.id("start_green")).getText());
        assertEquals("Start loading green", driver.findElement(By.id("start_green")).getText());
...
//         TODO:
        WebDriverWait wait = (WebDriverWait) new WebDriverWait(driver, 10); //old variant
//         * 1) click on start loading green button
        driver.findElement(By.id("start_green")).click();
//         * 2) check that button does not appear,
        assertFalse(driver.findElement(By.id("start_green")).isDisplayed());
...
//        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("green_and_blue_status")));
