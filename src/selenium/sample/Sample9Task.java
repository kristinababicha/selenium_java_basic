...
//         TODO:
//         * 1) click on start loading green button
        driver.findElement(By.id("start_green")).isDisplayed();
...
//         * success is seen instead "Green Loaded"
    ...
    public void loadGreenAndBlueBonus() {
        /* TODO:
         * 0) wait until button to load green and blue appear
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.id("green_and_blue_status")));
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[@id='start_green_and_blue']")));
