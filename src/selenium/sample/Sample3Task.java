...
//         fail with custom error message:
        String errorText = "CUSTOM ERROR TEXT";
        assertTrue(errorText, driver.findElement(By.id("buttonId")).getAttribute("value").equalsIgnoreCase("This is also a button"));
...
//        contain number 190
        ...
        for (WebElement allElements : elements) {
            if (allElements.getText().contains("190"))
                fail();
        }
    }
}
