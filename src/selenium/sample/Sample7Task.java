...
//        check that "Option 1" and "Option 3" are not ticked, but "Option 2" is ticked
        assertFalse(driver.findElement(By.xpath("//*[@id='vfb-6-0']")).isSelected());
        assertFalse(driver.findElement(By.xpath("//*[@id='vfb-6-2']")).isSelected());
        assertTrue(driver.findElement(By.xpath("//*[@id='vfb-6-1']")).isSelected());
...
//        check that none of the radio are selected
    List<WebElement> radioNotSelected = driver.findElements(By.xpath("//*[@type = 'radio']"));
    for (WebElement radio : radioNotSelected) {assertFalse(radio.isSelected());}

//        select  "Option 3"
        radioNotSelected.get(2).click();

//        check that "Option 1" and "Option 2' are not select, but "Option 3" is selected
        assertFalse(radioNotSelected.get(0).isSelected());
        assertFalse(radioNotSelected.get(1).isSelected());
        assertTrue(radioNotSelected.get(2).isSelected());

//        select  "Option 1"
        radioNotSelected.get(0).click();

//        check that "Option 2" and "Option 3' are not select, but "Option 1" is selected
        assertTrue(radioNotSelected.get(0).isSelected());
        assertFalse(radioNotSelected.get(1).isSelected());
        assertFalse(radioNotSelected.get(2).isSelected());
...
//        select "Option 3" in Select
        Select dropdownList = new Select(driver.findElement(By.id("vfb-12")));
