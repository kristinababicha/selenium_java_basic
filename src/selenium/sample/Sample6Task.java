...
//        1-2 ways to find text: "Test Text 3"
        System.out.println(driver.findElements(By.xpath("//*div[@id=\"test1\"]/*")).get(0).getText());
//        1-2 ways to find text: "Test Text 4"
        System.out.println(driver.findElement(By.xpath("//*[text()='Test Text 4']")).getText());
//        1-2 ways to find text: "Test Text 5"
        System.out.println(driver.findElement(By.xpath("//*[@class=\"Test Text 5\"]")).getText());
...
//        1-2 ways to find text: "Test Text 3"
        System.out.println(driver.findElement(By.cssSelector("#test3")).getText());
//        1-2 ways to find text: "This is also a button"
